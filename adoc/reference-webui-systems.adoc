...
=== menu:System Details[Virtualization]
...
Traditional systems have two additional subtabs, [guimenu]``Provisioning``, and [guimenu]``Deployment``.
...
[float]
[[sdc-virt-host-place]]
==== System Details > Virtualization> Guests

[guimenu]``Guests`` is the default tab.
...
==== System Details > Virtualization > Deployment [Management]
...
The following section lists available SSM functions and provides information on what actions may be performed across both Salt and Traditional systems.
These two methods have different actions which may be accessed with the System Set Manager:

=== Available SSM Functions

The following functions are available for use with the System Set manager. The tables for each function list support status for Salt and traditional clients.

List Systems::
List available systems for use with SSM.

|===
| Function | Traditional SSM | Salt SSM

| List Systems | Supported | Supported
|===

Install Patches::
Schedule patch updates on selected systems.
|===
| Function | Traditional SSM | Salt SSM
...
Install Packages::
Upgrade, Install, Remove and Verify packages on selected clients.
|===
|Function | Traditional SSM | Salt SSM

| Upgrade Packages | Supported | Supported
| Install Packages | Supported | Supported
| Remove Packages  | Supported | Supported
| Verify Packages  | Supported | Not Available
|===
...
| Create Group | Supported | Supported
| Manage Group | Supported | Supported
|===

Channels::
Adjust channel membership, channel subscriptions deploy and diff between channels.
|===
| Function | Traditional SSM | Salt SSM

| Channel Memberships | Supported | Supported
| Channel Subscriptions | Supported | Not Available
| Deploy / Diff Channels | Supported | Not Available
|===

Provisioning::
Autoinstall systems, tag for a snapshot, execute remote commands, and work with power management and operations.
|===
| Function | Traditional SSM | Salt SSM

| Autoinstall Systems | Supported | Not Available
| Tag for a Snapshot | Supported | Not Available
| Remote Commands | Supported | Not Available
| Power Management | Supported | Not Available
| Power Management Operations | Supported | Not Available
|===
...
| Update System Preferences                          | Supported | Supported
| Update Hardware Profiles                           | Supported | Supported
| Update Package Profiles                            | Supported | Supported
| Run Remote Commands                                | Supported | Supported
| Set and Remove Custom Values for Selected Systems  | Supported | Supported
| Reboot Systems                                     | Supported | Supported
| Migrate Systems to another Organization            | Supported | Supported
| Delete Systems from SUSE Manager                   | Supported | Supported
|===
